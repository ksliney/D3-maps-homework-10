...
},{"topojson-client":"../node_modules/topojson/node_modules/topojson-client/index.js","topojson-server":"../node_modules/topojson/node_modules/topojson-server/index.js","topojson-simplify":"../node_modules/topojson/node_modules/topojson-simplify/index.js"}],"pudding/us.topojson":[function(require,module,exports) {
"use strict";

module.exports = "/us.44a0f661.topojson";
},{}],"pudding/incarceration_2.csv":[function(require,module,exports) {
"use strict";

module.exports = "/incarceration_2.829b1df2.csv";
},{}],"pudding/all_points_5.csv":[function(require,module,exports) {
"use strict";

module.exports = "/all_points_5.4d9a1d15.csv";
...
var svg = d3.select('#chart-6').append('svg').attr('height', height + margin.top + margin.bottom).attr('width', width + margin.left + margin.right).style('background', 'black').append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')');
var projection = d3.geoAlbersUsa(); // out geoPath needs a PROJECTION variable

var path = d3.geoPath().projection(projection);
Promise.all([d3.json(require('./pudding/us.topojson')), d3.csv(require('./pudding/incarceration_2.csv')), d3.csv(require('./pudding/all_points_5.csv'))]).then(ready).catch(function (err) {
...
function ready(_ref) {
  var _ref2 = _slicedToArray(_ref, 3),
      json = _ref2[0],
      incarceration = _ref2[1],
      allPoints = _ref2[2];

  var states = topojson.feature(json, json.objects.states);
  states.features = states.features.filter(function (d) {
  ...
  svg.append('g').attr('transform', 'translate(-140,-10) scale(1.22)').selectAll('.state').data(states.features).enter().append('path').attr('class', 'state').attr('d', path).attr('fill', 'rgba(0,0,0,0.01)').on('mouseenter', function (d) {
  ...
  var radiusScale = d3.scaleSqrt().domain([1000, 50000]).range([1, 3.5]).clamp(true);
  ...
  var jailExtent = d3.extent(allPoints, function (d) {
    return d.jail_black_2010 / d.total_2010;
  });
  var colorScale = d3.scaleSequential(d3.interpolatePlasma).domain(jailExtent).clamp(true);
  var xPositionScale = d3.scaleLinear().domain(xExtent).range([0, width]);
  var yPositionScale = d3.scaleLinear().domain(yExtent).range([height, 0]);
  svg.append('g').lower().selectAll('circle').data(allPoints).enter().append('circle').attr('r', 2).attr('cx', function (d) {
...
},{"d3":"../node_modules/d3/index.js","topojson":"../node_modules/topojson/index.js","./pudding/us.topojson":"pudding/us.topojson","./pudding/incarceration_2.csv":"pudding/incarceration_2.csv","./pudding/all_points_5.csv":"pudding/all_points_5.csv"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","06-map.js"], null)
//# sourceMappingURL=/06-map.817c3d60.map