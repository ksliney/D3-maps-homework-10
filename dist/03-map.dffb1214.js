...
},{}],"data/wafflehouses.csv":[function(require,module,exports) {
"use strict";

module.exports = "/wafflehouses.47d9221b.csv";
},{}],"03-map.js":[function(require,module,exports) {
"use strict";
...
Promise.all([d3.json(require('./data/us_states.topojson')), d3.csv(require('./data/wafflehouses.csv'))]).then(ready).catch(function (err) {
...
function ready(_ref) {
  ...
  var states = topojson.feature(json, json.objects.us_states); // Not sure how to do scale/center/etc?
  ...
  svg.selectAll('.wafflehouse').data(datapoints).enter().append('circle').attr('class', 'wafflehouse').attr('r', 2).attr('transform', function (d) {
...
},{"d3":"../node_modules/d3/index.js","topojson":"../node_modules/topojson/index.js","./data/us_states.topojson":"data/us_states.topojson","./data/wafflehouses.csv":"data/wafflehouses.csv"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","03-map.js"], null)
//# sourceMappingURL=/03-map.dffb1214.map