...
function ready(json) {
  ...
  console.log(countries); // our .attr('d' needs a PATH variable

  svg.selectAll('.country').data(countries.features).enter().append('path').attr('class', 'country').attr('d', path);
  console.log(graticule());
  svg.append('path').datum(graticule()).attr('d', path).attr('stroke', 'red');
}
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","01-map.js"], null)
//# sourceMappingURL=/01-map.515972a4.map