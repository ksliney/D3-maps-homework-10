...
},{}],"02-map.js":[function(require,module,exports) {
"use strict";
...
d3.json(require('./data/us_states.topojson')).then(ready).catch(function (err) {
...
function ready(json) {
  ...
  svg.selectAll('.state').data(states.features).enter().append('path').attr('class', 'state').attr('d', path).attr('stroke', 'white').attr('fill', function (d) {
    console.log(d);
  ...
  }).attr('text-anchor', 'middle').attr('alignment-baseline', 'middle').attr('font-size', 10);
}
},{"d3":"../node_modules/d3/index.js","topojson":"../node_modules/topojson/index.js","./data/us_states.topojson":"data/us_states.topojson"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","02-map.js"], null)
//# sourceMappingURL=/02-map.7ab4289d.map